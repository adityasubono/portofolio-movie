                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-info">
                                <h3>AdityaSubono</h3>
                                <p>
                                    Perumahan Bumi Citra Asri Blok D1 No.5 <br/>
                                    RT.03 / RW.12<br/>
                                    Tonjong, Tajur Halang, Kab. Bogor, Jawa Barat<br/>
                                    <strong>Phone:</strong> 08568909003<br/>
                                    <strong>Email:</strong> adityasubono@gmail.com<br/>
                                </p>
